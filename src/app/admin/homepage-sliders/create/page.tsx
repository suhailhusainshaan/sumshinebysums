...
export default function CreateHomepageSliderPage() {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      const response = await api.post<ApiResponse<HomepageSlider>>('/admin/homepage/sliders', payload, {
        headers: {
      ...
      let message = 'Unable to create slider.';
  ...
  return (
    <div>
      <PageBreadcrumb pageTitle="Create Homepage Slider" />

      <ComponentCard title="Create Slider" desc="Upload a new image to use as a homepage banner.">
